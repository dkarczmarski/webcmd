...
//
//	mockgen -typed -source=cmdrunner.go -destination=internal/mocks/mock_cmdrunner.go -package=mocks
//
...
func (mr *MockCommandMockRecorder) Run() *MockCommandRunCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Run", reflect.TypeOf((*MockCommand)(nil).Run))
	return &MockCommandRunCall{Call: call}
}

// MockCommandRunCall wrap *gomock.Call
type MockCommandRunCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockCommandRunCall) Return(arg0 error) *MockCommandRunCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockCommandRunCall) Do(f func() error) *MockCommandRunCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockCommandRunCall) DoAndReturn(f func() error) *MockCommandRunCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
